...
from ui.components import alerta_aviso, alerta_info, alerta_sucesso, card_estatistica
from utils.persistence import clear_history, load_history, save_history
